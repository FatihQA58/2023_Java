...
public class Iterators01 {
        ...
        3)There are two types of iterators
                i)Iterator:
                    You can just "remove" the elements, it is not impossible to "update" or to "add" new elements
     ...
     */
        public static void main(String[] args) {
            ...
            myList.add("Angle");
            myList.add("Mark");
            System.out.println(myList);//[Tom, Jim, Clara, Angle, Mark]
            ...
            yourList.add("Clara");
            yourList.add("Angle");
            System.out.println(yourList);//[Tom, Jim, Clara, Angle]
