...
public class Student {
    ...
    Because, in overriding we change the method body, but final methods do not let us to change the method body.
            */
    private String studentId="TH102HL";
    private boolean success=true;

    //create a get method to read the value of studentId
   /*//1.Way
...
*/
    ...
    //If data-type of an encapsulated data is boolean,getter method name starts with "is" not with "get"
